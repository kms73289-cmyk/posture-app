...
class MonitorPage(tk.Frame):
    ...
    def _build(self):
        ...
        def S(v):
            return int(v * scale)
        self.bg_img = Image.open("assets/bg_monitor.png")
        self.bg_photo = ImageTk.PhotoImage(self.bg_img)
        wrapper = tk.Frame(self, bg=BG_APP)
        wrapper.pack(fill="both", expand=True, padx=S(70), pady=S(32))
        ...
        self.panel = tk.Frame(self.main_card, bg=BG_CARD)
    ...
    def _countdown_tick(self):
        ...
        if self._countdown > 0:
            ...
            self.panel.pack(fill="x", padx=120, pady=(0, 8))

            self._stop_btn.pack(fill="x", pady=(0, 6))
            self._recal_btn.pack(fill="x", pady=(0, 6))
            self._hide_btn.pack(fill="x")
    ...
    def _on_stop(self):
        ...
        self._start_btn.pack(fill="x", padx=190, pady=(0, 8))
